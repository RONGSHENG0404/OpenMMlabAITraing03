...
log_level = 'INFO'
load_from = 'work_dirs/rtmdet_tiny_1xb24-50e_drink/best_coco/bbox_mAP_epoch_40.pth'
resume = False
train_cfg = dict(
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(type='AdamW', lr=0.000375, weight_decay=0.05),
    paramwise_cfg=dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(
            ...
            palette=[(220, 20, 60), (20, 50, 100), (20, 90, 40), (180, 80, 30),
                     (220, 220, 220), (100, 50, 10), (144, 192, 112),
                     (138, 51, 60), (154, 89, 11), (92, 12, 11)])),
    pin_memory=False)
val_dataloader = dict(
    batch_size=1,
    num_workers=2,
...
metainfo = dict(
    classes=('cola', 'pepsi', 'sprite', 'fanta', 'spring', 'ice', 'scream',
             'milk', 'red', 'king'),
    palette=[(220, 20, 60), (20, 50, 100), (20, 90, 40), (180, 80, 30),
             (220, 220, 220), (100, 50, 10), (144, 192, 112), (138, 51, 60),
             (154, 89, 11), (92, 12, 11)])
num_classes = 10
...
num_epochs_stage2 = 5
launcher = 'none'
work_dir = './work_dirs/rtmdet_tiny_1xb24-50e_drink'
